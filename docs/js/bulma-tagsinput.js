...
b.setAttribute("selected","selected"),b.selected=!0}}/**
     ...
     * }]
     * @param {String|Object} item 
     */},{key:"add",value:function add(a){var b=this;// Check if number of items is limited ans reached
...
if(b.options.allowDuplicates||!b.has(a)){var c={value:b._objectItems?a[b.options.itemValue]:a,text:b._objectItems?a[b.options.itemText]:a},d=b._createTag(c);b.items.push(a),b._propagateChange(),b.emit("after.add",{item:a,tag:d})}else{if(b.options.highlightDuplicate){var e=Array.from(b.container.children).filter(function(a){return a.classList.contains("tag")})[b.indexOf(a)];e&&(e.classList.add("is-duplicate"),setTimeout(function(){e.classList.remove("is-duplicate")},1250))}b.emit("item.duplicate",a)}}),this}/**
